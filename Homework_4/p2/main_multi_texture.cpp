...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("../../data/shaders/hw4_p2.vs", "../../data/shaders/hw4_p2.fs");
...
//    apperance_0->addLightSource(light_source);
    ...
    spotlight_source._specular_intensity = 10.0;
    spotlight_source._diffuse_intensity = 0.0;
    spotlight_source._attenuation_coeff = 0.0;
    spotlight_source._cone_direction = glm::vec3(0.0, 0.0, -1.0);
    spotlight_source._cone_angle = 180.0;
    
    apperance_0->addLightSource(spotlight_source);
	
    // Create a material object
    GLMaterial material_0;
    material_0._diffuse_material = glm::vec3(0.0, 5.0, 0.0);
    material_0._ambient_material = glm::vec3(1.0, 1.0, 1.0);
    material_0._specular_material = glm::vec3(1.0, 1.0, 0.5);
    ...
    int textureId = texture->loadAndCreateTextures("../../data/textures/color-map_landscape.bmp", "../../data/textures/noise-map_city.bmp");
...
//        bool ret = colorMap->setTextureBlendMode(g_change_texture_blend);
