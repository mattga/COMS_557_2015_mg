...
class GLSphereYellow : public GLSphere
{
public:

    GLSphereYellow(float center_x, float center_y, float center_z, float radius, int rows = 10, int segments = 10 );
    ~GLSphereYellow();
...
protected:
    ...
    GLSpotLightSource           _light_source3;
